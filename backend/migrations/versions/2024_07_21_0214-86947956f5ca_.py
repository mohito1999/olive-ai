...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Text(), server_default=sa.text("id_generator('campaign')"), nullable=False),
    ...
    sa.Column('telephony_service_id', sa.Text(), nullable=True),
    sa.Column('telephony_service_config', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('transcriber_id', sa.Text(), nullable=True),
    ...
    sa.Column('synthesizer_id', sa.Text(), nullable=True),
