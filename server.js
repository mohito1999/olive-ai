...
const auth = new google.auth.GoogleAuth({
  keyFile: 'service-account-key.json', // Path to your Service Account Key JSON file
...
app.post('/webhook', async (req, res) => {
  try {
    ...
    const blandData = {
      ...
      language: 'en',
      record: true,
      webhook: 'https://your-app-name.herokuapp.com/webhook', // Update this URL after deploying
